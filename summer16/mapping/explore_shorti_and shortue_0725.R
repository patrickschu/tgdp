...
hair=read.csv('/Users/ps22344/Downloads/tgdp/summer16/mapping/shortishortue_merged.csv', header=T)
summary(hair)
nrow(hair)
...
outputfile='entire dataset by sound'
#Make F1 - F2 plot
png(paste(outputfile, "F1_F2.png", sep="_"),  width=960, height=640, res=100);
	...
	plot(hair$oF2, hair$oF1, ylim=c(f1range[1]-50, f1range[2]+30), xlim=c(1100, f2range[2]+100), xlab="F2", ylab="F1", type="n",
	 main=paste("F1 - F2 Scatterplot of all tokens of ɪ  and ʏ in ", outputfile, ",", tokens, "tokens"));

	text( hair$oF2, hair$oF1, labels=hair$variable, cex=1,  col=c("red", "blue")[hair$gender]);

	points (1387, 400, col="blue", pch="ʏ", cex=2.5);
	points (2025, 371, col="blue", pch="ɪ", cex=2.5);		
	#points(1162.02, 511.64, col="green", pch="P", cex=2);
	legend('bottomright', legend="Speaker number; men in blue, women in red; blue means from Rausch 72; green are Patrick's vowels", cex=0.9);
...
png(paste(outputfile, "F1_F3.png", sep="_"),  width=960, height=640, res=100);
	...
	type="n", main=paste("F1 - F3 Scatterplot of all tokens of ɪ and ʏ in ", ",", tokens, "tokens"));

	text( hair$oF3, hair$oF1, labels=hair$variable, cex=1, col=c("red", "blue")[hair$gender]);
...
outputfile='entire dataset by sound_colorcoded'
#Make F1 - F2 plot
png(paste(outputfile, "F1_F2.png", sep="_"),  width=960, height=640, res=100);
	...
	text( hair$oF2, hair$oF1, labels=hair$variable, cex=1,  col=c("red", "black")[hair$variable]);

	points (1387, 400, col="blue", pch="ʏ", cex=2.5);
	points (2025, 371, col="blue", pch="ɪ", cex=2.5);		
	#points(1162.02, 511.64, col="green", pch="P", cex=2);
	legend('bottomright', legend="vowels colorcoded; blue means from Rausch 72; green are Patrick's vowels", cex=0.9);
...
png(paste(outputfile, "F1_F3.png", sep="_"),  width=960, height=640, res=100);
	...
	plot(hair$oF3, hair$oF1, ylim=c(f1range[1]-50, f1range[2]+30), xlim=c(f3range[1]-100, f3range[2]+100), xlab="F3", ylab="F1",
	type="n", main=paste("F1 - F3 Scatterplot of all tokens of ɪ and ʏ in ", outputfile, ",", tokens, "tokens"));

	text( hair$oF3, hair$oF1, labels=hair$variable, cex=1, col=c("red", "black")[hair$variable]);


	#points(2521.04, 549, col="green", pch="P", cex=2);
	legend('bottomright', legend="vowels colorcoded; 'P' is Patrick's vowel", cex=0.9);
...
#PUT INTO VOWEL TRAPEZOID

outputfile='entire dataset in trapezoid'
#Make F1 - F2 plot
png(paste(outputfile, "F1_F2.png", sep="_"),  width=960, height=640, res=100);

	plot(hair$oF2, hair$oF1, ylim=c(1000,300), xlim=c(3000, 500), xlab="F2", ylab="F1", type="n",
	 main=paste("F1 - F2 Scatterplot of all tokens of ɪ  and ʏ in ", outputfile, ",", tokens, "tokens"));
	...
	points (2025, 371, col="blue", pch="ɪ", cex=2.5);		
	#points(1162.02, 511.64, col="green", pch="P", cex=2);
	legend('bottomright', legend="Vowels colorcoded; blue means from Rausch 72", cex=0.9);
