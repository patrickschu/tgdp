...
def spreadmerger(spreadsheet_1, spreadsheet_2, filename=False):
	...
	outputspread.to_csv("shortishortue_merged.csv", encoding="utf-8", na_rep="NA", index=False, cols=spreadsheet2.columns)
	print "File written to", os.path.join(os.path.split(spreadsheet_1)[1]+os.path.split(spreadsheet_2)[1]+"_merged.csv")
	return outputspread

spreadmerger('/Users/ps22344/Downloads/tgdp/summer16/mapping/gilbertsound_1.csvgilbertsound_16.csv_merged.csvgilbertsound_21.csv_merged.csvgilbertsound_111.csv_merged.csvgilbertsound_125.csv_merged.csv', '/Users/ps22344/Downloads/tgdp/summer16/mapping/gilbertsound_26_shorti.csvgilbertsound_74_shorti.csv_merged.csvgilbertsound_114_shorti.csv_merged.csvgilbertsound_125_shorti.csv_merged.csv' )
