...
hair=read.csv('/Users/ps22344/Downloads/tgdp/summer16/gilberttools/gilbertsound_74_shorti.csv', header=T)
outputfile='sentence 74'
...
png(paste(outputfile, "F1_F2.png", sep="_"),  width=960, height=640, res=100);
	...
	points(2333.43, 882.10, col="green", pch="P", cex=2);
...
png(paste(outputfile, "F1_F3.png", sep="_"),  width=960, height=640, res=100);
	...
	points(2579.32, 882.10, col="green", pch="P", cex=2);
...
#Patricks milch 882.10	2333.43	3021.61
