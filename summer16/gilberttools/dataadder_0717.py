...
def dataadder(input_spread, file_name_column, input_folder, cat_to_add="new_column"):
	...
	with open("gilbertsound_74_shorti.csv", "w") as outputspread:
		inputspread.to_csv(outputspread, encoding='utf-8', index=False)
	print header, "File written to", outputspread
	
	
dataadder('/Users/ps22344/Desktop/dataset_rounding/short_i/74/74.csv', 'id', "/Users/ps22344/Desktop/dataset_rounding/short_i/74/74_measurements", 'F1')