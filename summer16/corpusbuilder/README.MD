...
## How to run it
Download [here](https://github.com/patrickschu/tgdp/blob/master/summer16/corpusbuilder/corpusbuilder_original.py). Run it in a shell. See here for instructions. 
